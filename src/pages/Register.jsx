...
function Register() {
  return (
    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      <div
        className="w-full lg:w-1/2 flex items-center justify-center bg-center bg-cover bg-no-repeat lg:bg-cover lg:bg-no-repeat lg:bg-left"
        style={{
          backgroundImage:
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-10">
        <form className="bg-stone-50 shadow-2xl rounded-2xl w-full max-w-md p-8 space-y-5">
          <h2 className="text-2xl font-bold text-[#384D48]">Register</h2>
          <div className='flex flex-row'>
          <div className='bg-[#384D48] w-12 h-12.5 flex justify-center items-center rounded-l-md'>
          <FaUser className='text-white' /></div>
          <input
            type="text"
